const Footer = () => {
  return (
    <footer className="lg:py-16 py-6 px-6 lg:px-0 bg-[#FBFBFB]" dir="rtl">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 lg:gap-12">
      ...
      <div className="max-w-7xl lg:mx-auto lg:mt-16 pt-8 lg:text-center">
